...
export const tours: Tour[] = [
  {
    ...
    overview: [
      "Luxor... Where history meets the Koky family.",
      "In Luxor, every stone tells a story, and we at Koky are creating unforgettable family memories with you in the world's largest open-air museum.",
  ...
  },
  {
    ...
    overview: [
      "Cairo through the eyes of the Koky family... where your story begins. ✨",
      "At Koky, we welcome you as family, not just as guests. We take you on a warm, family-friendly journey that beautifully combines history, spirituality, and togetherness.",
    ...
    itinerary: [
      ...
      },
      {
        ...
        description: "A walk through the heart of Old Cairo; enjoy shopping at the historic bazaar and admire the medieval Islamic architecture of Al-Muizz Street. A Note from Koky: We pay attention to every detail to ensure you have an unforgettable journey through history."
      },
      {
      ...
      },
      {
        ...
        description: "🗺️ Koky's advice: This tour is fully within pedestrian zones, making it easy and safe to explore Coptic Cairo on foot. Perfect for families, seniors, and anyone interested in religious history and architecture."
      },
      {
        title: "Limousine + Taxi",
  ...
  },
  {
    ...
    overview: [
      "Marsa Alam... Discover paradise with the Koky family. ✨",
      "At Koky, we believe the most beautiful moments are those shared with family in the heart of untouched nature.",
      ...
      "In Marsa Alam, you’re not just tourists — you’re guests in the Koky family home."
    ],
    itinerary: [
      {
  ...
  },
  {
    ...
    overview: [
      ...
      "With Koky, Fayoum becomes a peaceful family retreat embraced by nature."
    ],
    itinerary: [
      {
        title: "Tunis Village",
  ...
  },
  {
    ...
    overview: [
      ...
      "With Koky, Siwa is not just a trip — it’s a soulful family journey."
    ],
    itinerary: [
      {
  ...
  },
  {
    ...
    overview: [
      "Aswan... The magic of the Nile and the warmth of the Koky family. ✨",
      ...
      "With Koky, you’re not just visitors in Aswan — you’re welcomed into the heart of the Nile."
    ],
    itinerary: [
      { 
  ...
  },
  {
    ...
    overview: [
      "Your family is always welcome at Koky in Hurghada. ✨",
      "Hurghada is more than just the sea — it’s about creating unforgettable memories with your loved ones. At Koky, we take you on a heartfelt journey filled with adventure, comfort, and togetherness.",
      ...
      "With Koky, you’re not just tourists — you’re part of our extended family."
    ],
    itinerary: [
      {
