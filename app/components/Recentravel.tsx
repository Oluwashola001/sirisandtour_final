...
const images = [
  '/images/Recenttravel/1.jpg',
  '/images/Recenttravel/2.jpg',
  '/images/Recenttravel/3.jpg',
  '/images/Recenttravel/4.jpg',
  '/images/Recenttravel/5.jpg',
  '/images/Recenttravel/6.jpg',
  '/images/Recenttravel/7.jpg',
...
export default function RecentTravelMoments() {
  ...
  return (
    ...
    <div className="relative w-full max-w-[90vw] md:max-w-[900px] h-[350px] md:h-[800px] mx-auto lg:mt-10 mt-12 -mb-25 md:mt-16">
